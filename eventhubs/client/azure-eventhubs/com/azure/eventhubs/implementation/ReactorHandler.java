...
public class ReactorHandler extends BaseHandler {
    ...
    private final Logger logger = LoggerFactory.getLogger(ReactorHandler.class);
    ...
    public void onReactorInit(Event e) {
        logger.info(String.format(Locale.US, "name[%s] reactor.onReactorInit", this.name));
    ...
    public void onReactorFinal(Event e) {
        logger.info(String.format(Locale.US, "name[%s] reactor.onReactorFinal", this.name));
    }
}
